...
Command counts: reference **289**, ported **140**, missing **149**.
...
- [x] COPY, DELEX, DEL, ECHO, EXISTS, EXPIRE, EXPIREAT, EXPIRETIME, KEYS,
  ...
  RENAME, RENAMENX, SELECT, STICK, TIME, TOUCH, TTL, TYPE, UNLINK
- [ ] DUMP, FIELDEXPIRE, FIELDTTL, RESTORE, RM, SCAN, SORT
