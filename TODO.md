...
Command counts: reference **289**, ported **139**, missing **150**.
...
- [x] COPY, DELEX, DEL, ECHO, EXISTS, EXPIRE, EXPIREAT, EXPIRETIME, KEYS,
  PERSIST, PEXPIRETIME, PEXPIRE, PEXPIREAT, PING, PTTL, RANDOMKEY, RENAME,
  RENAMENX, SELECT, STICK, TIME, TOUCH, TTL, TYPE, UNLINK
- [ ] DUMP, FIELDEXPIRE, FIELDTTL, MOVE, RESTORE, RM, SCAN, SORT
